                        ...
                        double* u_zero_val)
{
	...
	case(3): {
		...
		if (SYSTEM_DIM > 2)
		{
			...
			if (SYSTEM_DIM > 9) 
			{
			    ...
			    /*if (SYSTEM_DIM > 14) */
			    /*{*/
				/*for (s_dim=10; s_dim < 15; s_dim++) u_zero_val[s_dim] = 2.0/5.0*val;*/
			    /*}*/
			}
		    }
		}
		...
		for (s_dim=0;s_dim<SYSTEM_DIM;s_dim++) u_zero_val[s_dim] = 0.0; 
	    }
	...
	case(6): {
       ...
       //u_zero_val[0] = 1.0*exp(-10.0*(((pow((y-y_0),2.0))/(2.0*pow(sigma_y,2.0)))));// + ((pow((y-y_0),2.0))/(2.0*pow(sigma_y,2.0)))));
		...
		if (SYSTEM_DIM > 5) 
		{
			...
			/*if (SYSTEM_DIM > 14) */
			/*{*/
			    /*for (s_dim=10; s_dim < 15; s_dim++) u_zero_val[s_dim] = 8.0/5.0*local_approx_sol[0];*/
			/*}*/
		    }
		}
	    }
	...
	case(13): {
	    ...
	    for (s_dim=1;s_dim<SYSTEM_DIM;s_dim++) u_zero_val[s_dim] = 0.0; 
	...
	case(17): {
	    ...
	    {
		/*if (x <= 1.0) {*/
		/*if ((x <= 0.5) && (y <= 5.6) && (y >= 5.4) ){*/
		    /*u_zero_val[0] = 15*pow(sin(PI*x),4.0);*/
		/*if (x <= 0.5) {*/
		if (x >= 10.9) {
		    if ( (y >= -5.55) && (y <= -5.35) ) {
		    u_zero_val[0] = 1.0;
                   ...
                   double* flux_val)
{
	...
	switch ((*user_param).closure) {
		...
		/*[>ensure_realizability_ortho_proj(uh_tn_sol);<]*/
		/*[>double u0tol = 1e-14;<]*/
		/*[>double normtol = 1e-14;<]*/
		/*[>u0tol = 1e+99;<]*/
		/*[>u0tol = 1e-6;<]*/
		/*[>normtol = 1e-6;<]*/

		/*[>ensure_realizability_ortho_proj(1e-9,1e-6,uh_tn_sol);<]*/
		/*ensure_realizability_vert_proj(1e-12,uh_tn_sol);*/
		/*double u0tol = 1e-6;*/
		/*double normtol = 1e-6;*/
		...
		/*else if (s_dim_count == 1) {*/
			...
			/*[>flux_val[0] = D[0] * uh_tn_sol[0];<]*/
			/*[>flux_val[1] = D[1] * uh_tn_sol[0];<]*/
		    /*}*/
		/*}*/
		/*else if(s_dim_count == 2) {*/
		    /*norm = sqrt(uh_tn_sol[1]*uh_tn_sol[1] + uh_tn_sol[2]*uh_tn_sol[2]);*/
        ...
        {
            realizability_hack(1e-06,uh_tn_sol);
        }*/
