        ...
        case(6):
            {
                ...
                u_zero_val[0] = exp(-10.0*(((pow((x-x_0),2.0))/(1.0*pow(sigma_x,2.0))) + ((pow((y-y_0),2.0))/(1.0*pow(sigma_y,2.0)))));
                        ...
                        double* bdry_f_val)
{
    ...
    double alpha =5.0; //degrees
    double shift = (7.0*pow((-1.0*(cos((PI*alpha)/180.0) - 1.0)*(cos((PI*alpha)/180) +1)),0.5))/(2.0*cos((PI*alpha)/180.0));
    //printf("shift = %lf \n",shift);
    double alpha1 = alpha*(PI/180.0);
    double alpha2 = (90.0+ alpha)*(PI/180.0); 
        ...
        case(27):
            {
                ...
                //if((y >=-4.0) && (y <=-3.0) && (fabs(x) < EPSILON)) 

                //if((y >=(3.0-shift)) && (y <=(4.0-shift)) && (fabs(x) < EPSILON))
              
                if((y >=3.0) && (y <=4.0) && (fabs(x) < EPSILON))
                {
                    //bdry_f_val[0] = 100;//62.733495998904842849697161000222;
                    //bdry_f_val[1] = 99.00;//56.451755972807482919506583129987;
                ...
                else if((x >=3.0) && (x <=4.0) && (fabs(y) < EPSILON))
                 {
                     ...
                     //bdry_f_val[2] = 99.0;//56.451755972807482919506583129987;
                    bdry_f_val[0]=100;
                    bdry_f_val[1]=0.0;
                    bdry_f_val[2]=99.0;
        ...
        case(50):
            {
                ...
                //if((fabs(x-1.5 < EPSILON)) && ((y>=(-0.05 -0.0)) && (y<=(0.05-0.0))))
                
              
                //if((fabs(x-3.0 < EPSILON)) && ((y>=(-0.2143-1.0)) && (y<=(0.2143-1.0))))
              
                //if(((fabs(x-3.0) < EPSILON)) && ((y>=(-0.2143+1.6)) && (y<=(0.2143+1.6))))
                
                
               if((fabs(x-7.0) < EPSILON) && ((y>=(3.00)) && (y<=(4.00)))) 
                { 
                ...
                else if((fabs(y - (0.0)) < EPSILON) && ((x>=(3.00)) && (x<=(4.00))))
                {
                    //bdry_f_val[0] = 62.733495998904842849697161000222;
                    //bdry_f_val[1] = 0.000000010684557813062850177457212275112;
                ...
                else if(s_dim_count == 1) 
                {
                    ...
                    else 
                    {
                        ...
                        if (f > 1.1547) 
                        {
                           ...
                           // printf("fx %10.16e fy %10.16e \n",uh_tn_sol[1],uh_tn_sol[2]);
                            f = 1.1547;
                            //getchar();
                        }
                        ...
                        int flag)
{
   ...
   else if((E > CHAR_EPSILON) && (((fabs(fx) < CHAR_EPSILON) && (fabs(fy) > CHAR_EPSILON)) || ((fabs(fy) < CHAR_EPSILON) && (fabs(fx) > CHAR_EPSILON)))) 
   {
       ...
       if(fx_zero_flag)
       {
           ...
           J_2D[1][0] = normal[1]*(chi_f- f*chi_f_prime);
       ...
       else
       {
           ...
           J_2D[1][0] = normal[0]*(chi_f- f*chi_f_prime);
